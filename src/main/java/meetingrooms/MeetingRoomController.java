...
public class MeetingRoomController {
    ...
    public void chooseMenuItem (int menuItem) {
        ...
        if (menuItem == 2){
            System.out.println("A tárgyalók neve visszafelé:");
            printNames(office.getMeetingRoomsInReverseOrder());
        }
        if (menuItem == 3){
            System.out.println("Adja meg, hogy páros vagy páratlan sorszámú tárgyalókat szeretne lekérni!");
        ...
        if (menuItem == 5){
            System.out.println("Adja meg a nevet, ami alapján keresni szeretne:");
            String name = scanner.nextLine();
            System.out.println("A kért tárgyaló adatai: ");
            printMeetingRoom(office.getMeetingRoomWithGivenName(name));
        }
        if (menuItem == 6){
            System.out.println("Adja meg a névtöredéket, ami alapján keresni szeretne:");
            String namePart = scanner.nextLine();
            System.out.println("A kért tárgyalók adatai: ");
            printMeetingRooms(office.getMeetingRoomsWithGivenNamePart(namePart));
        }
        if (menuItem == 7){
            System.out.println("Adja meg a területet, amelynél nagyobb tárgyalókra kiváncsi: ");
            int area = scanner.nextInt();
            scanner.nextLine();
            printMeetingRooms(office.getMeetingRoomWithAreaLargerThan(area));
        }
        if (menuItem == 8){
